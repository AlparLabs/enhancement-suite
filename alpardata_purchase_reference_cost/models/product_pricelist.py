...
class ProductPricelistItem(models.Model):
    ...
    v19 note: _compute_base_price signature requires **kwargs for forward
    compatibility with Odoo's extensible pricing pipeline.
    """
    ...
    def _compute_base_price(
        ...
        **kwargs,
        ...
        :param kwargs: unused parameters for forward compatibility
