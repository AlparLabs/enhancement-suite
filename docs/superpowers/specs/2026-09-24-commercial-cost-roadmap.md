...
| 4 | Cotización comercial (USD) | `alpardata_commercial_currency_rate` | `2026-09-24-commercial-currency-rate-design.md` | `plans/2026-09-24-commercial-currency-rate.md` | base (refactor del 1) |
...
Después 2 → 3 → 4 → 5. 2, 3 y 5 son independientes entre sí; 4 toca el módulo base, así
que conviene que no corra en paralelo con 1.
...
- El módulo base no aplica `reference_cost` como precio en las OC generadas por
  reabastecimiento (`_prepare_purchase_order_line`).
