...
class ResConfigSettings(models.TransientModel):
    ...
    receipt_customer_product_account_id = fields.Many2one(related='company_id.receipt_customer_product_account_id', readonly=False)
    ...
    receipt_vendor_product_account_id = fields.Many2one(related='company_id.receipt_vendor_product_account_id', readonly=False)
